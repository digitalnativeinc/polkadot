...
fn availability_is_recovered_from_chunks_if_no_group_provided() {
    ...
    test_harness_fast_path(|mut virtual_overseer| async move {
        ...
        test_state
            .respond_to_available_data_query(&mut virtual_overseer, false)
            .await;
        test_state
            .respond_to_query_all_request(&mut virtual_overseer, |_| false)
            .await;
...
fn returns_early_if_we_have_the_data() {
    ...
    test_harness_chunks_only(|mut virtual_overseer| async move {
        ...
        test_state.test_runtime_api(&mut virtual_overseer).await;
        test_state
            .respond_to_available_data_query(&mut virtual_overseer, true)
            .await;
...
fn does_not_query_local_validator() {
    ...
    test_harness_chunks_only(|mut virtual_overseer| async move {
        ...
        test_state
            ...
            .await;
        test_state
            .respond_to_query_all_request(&mut virtual_overseer, |i| i == 0)
            .await;
