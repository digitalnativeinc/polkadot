...
mod tests {
    ...
    use crate::mock::{
        new_test_ext, Configuration, MockGenesisConfig, Origin, SessionInfo, Shared, System,
    };
    ...
    fn session_info_active_subsets() {
        ...
        new_test_ext(genesis_config()).execute_with(|| {
            Shared::set_active_validators_with_indices(active_set.clone(), validators.clone());
