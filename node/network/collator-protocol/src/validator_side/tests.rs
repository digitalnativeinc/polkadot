...
use polkadot_node_network_protocol::{our_view, request_response::Requests, ObservedRole};
...
fn act_on_advertisement() {
    ...
    test_harness(|test_harness| async move {
        ...
        overseer_send(
            ...
            CollatorProtocolMessage::NetworkBridgeUpdateV1(NetworkBridgeEvent::PeerMessage(
                peer_b.clone(),
                protocol_v1::CollatorProtocolMessage::AdvertiseCollation(test_state.relay_parent),
            )),
        )
        .await;
...
fn fetch_collations_works() {
    ...
    test_harness(|test_harness| async move {
        ...
        response_channel
            .send(Ok(CollationFetchingResponse::Collation(
                candidate_a.clone(),
                PoV {
...
fn activity_extends_life() {
    ...
    test_harness(|test_harness| async move {
        ...
        overseer_send(
            ...
            CollatorProtocolMessage::NetworkBridgeUpdateV1(NetworkBridgeEvent::PeerMessage(
                peer_b.clone(),
                protocol_v1::CollatorProtocolMessage::AdvertiseCollation(hash_a),
            )),
        )
        .await;
        ...
        overseer_send(
            ...
            CollatorProtocolMessage::NetworkBridgeUpdateV1(NetworkBridgeEvent::PeerMessage(
                peer_b.clone(),
                protocol_v1::CollatorProtocolMessage::AdvertiseCollation(hash_b),
            )),
        )
        .await;
        ...
        overseer_send(
            ...
            CollatorProtocolMessage::NetworkBridgeUpdateV1(NetworkBridgeEvent::PeerMessage(
                peer_b.clone(),
                protocol_v1::CollatorProtocolMessage::AdvertiseCollation(hash_c),
            )),
        )
        .await;
