...
pub(crate) struct RequestResultCache {
    ...
    validation_code_by_hash:
        MemoryLruCache<(Hash, ValidationCodeHash), ResidentSizeOf<Option<ValidationCode>>>,
...
impl RequestResultCache {
    ...
    pub(crate) fn cache_authorities(
        ...
        self.authorities
            .insert(relay_parent, VecOfDoesNotAllocate(authorities));
    }
    ...
    pub(crate) fn cache_validators(&mut self, relay_parent: Hash, validators: Vec<ValidatorId>) {
        self.validators
            .insert(relay_parent, ResidentSizeOf(validators));
    }
    ...
    pub(crate) fn cache_validator_groups(
        ...
        self.validator_groups
            .insert(relay_parent, ResidentSizeOf(groups));
    }
    ...
    pub(crate) fn cache_availability_cores(&mut self, relay_parent: Hash, cores: Vec<CoreState>) {
        self.availability_cores
            .insert(relay_parent, ResidentSizeOf(cores));
    }
    ...
    pub(crate) fn cache_persisted_validation_data(
        ...
        self.persisted_validation_data
            .insert(key, ResidentSizeOf(data));
    }
    ...
    pub(crate) fn cache_session_index_for_child(
        ...
        self.session_index_for_child
            .insert(relay_parent, ResidentSizeOf(index));
    }
    ...
    pub(crate) fn cache_candidate_pending_availability(
        ...
        self.candidate_pending_availability
            .insert(key, ResidentSizeOf(value));
    }
    ...
    pub(crate) fn cache_candidate_events(
        ...
        self.candidate_events
            .insert(relay_parent, ResidentSizeOf(events));
    }
    ...
    pub(crate) fn cache_session_info(
        &mut self,
        key: (Hash, SessionIndex),
        value: Option<SessionInfo>,
    ) {
