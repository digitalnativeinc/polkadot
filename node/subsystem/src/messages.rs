...
pub enum CandidateBackingMessage {
    ...
    GetBackedCandidates(
        Hash,
        Vec<CandidateHash>,
        oneshot::Sender<Vec<BackedCandidate>>,
    ),
...
pub enum CollatorProtocolMessage {
    ...
    DistributeCollation(
        CandidateReceipt,
        PoV,
        Option<oneshot::Sender<SignedFullStatement>>,
    ),
...
pub enum DisputeCoordinatorMessage {
    ...
    QueryCandidateVotes(
        SessionIndex,
        CandidateHash,
        oneshot::Sender<Option<CandidateVotes>>,
    ),
...
pub enum AvailabilityStoreMessage {
    ...
    QueryChunk(
        CandidateHash,
        ValidatorIndex,
        oneshot::Sender<Option<ErasureChunk>>,
    ),
...
pub enum ApprovalVotingMessage {
    ...
    ApprovedAncestor(
        Hash,
        BlockNumber,
        oneshot::Sender<Option<(Hash, BlockNumber)>>,
    ),
}
