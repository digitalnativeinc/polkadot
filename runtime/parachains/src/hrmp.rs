...
fn preopen_hrmp_channel<T: Config>(
    ...
    <Module<T>>::init_open_channel(sender, recipient, max_capacity, max_message_size)?;
...
mod tests {
    use super::*;
    use crate::mock::{
        new_test_ext, Configuration, Event as MockEvent, Hrmp, MockGenesisConfig, Paras, Shared,
        System, Test,
    };
